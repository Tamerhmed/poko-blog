  ...
  return (
    <div className="post-details">
      ...
      <h1 className="post-details-title">{post?.title}</h1>
        <img src={post?.user.profilePhoto.url} alt="profile pic" className="post-details-user-image" />
        <div className="post-details-user">
          
            <Link className= "author-name" to={`/profile/${post?.user._id}`}>{post?.user.username}</Link>
